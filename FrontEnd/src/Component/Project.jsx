    ...
    <div className="flex-1 bg-main min-h-full p-8 lg:p-8 overflow-y-auto no-scrollbar animate-in fade-in duration-700  ">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300" onClick={closeModal}>
          <div className="bg-[#1d2125] text-white w-full  rounded-xl border border-[#ffffff10] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
