...
import { Eye, EyeOff, Lock, Mail, ChevronRight, Layout, ShieldCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 font-sans">
      <div className="w-full max-w-[440px] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex flex-col items-center gap-3">
           <div className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-xl transition-all duration-500 ${
             loginType === "admin"
               ? "bg-indigo-600 shadow-indigo-600/10"
               : "bg-slate-900 shadow-slate-900/10"
           }`}>
              {loginType === "admin" ? (
                <ShieldCheck className="text-white animate-in zoom-in-50 duration-300" size={24} />
              ) : (
                <Layout className="text-white animate-in zoom-in-50 duration-300" size={24} />
              )}
           </div>
            ...
            <div className="space-y-2">
               ...
               <div className="relative group">
                  ...
                  <input 
                    ...
                    placeholder={loginType === "admin" ? "admin@worksphere.com" : "name@company.com"}
                  />
               </div>
            </div>
